        ...
        <div className="pt-12 md:pt-20" data-aos="zoom-out">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="md:text-xl text-gray-600 dark:text-gray-300 mt-5">
              ...
              required to form a team of <strong>1-3</strong> members (Inter
              college teams allowed) in order to take part in the contest and to
              draw effective and efficient solutions to the given problems.
            </p>
          </div>
        </div>
